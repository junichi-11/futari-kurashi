...
const checks = {
  ...
  "five affiliate CTAs": (detail.match(/nofollow sponsored noopener/g) || []).length === 5,
  ...
  "detail navigation": detail.includes("記事一覧へ戻る") && detail.includes("MARGINトップへ戻る") && detail.includes("関連記事"),
