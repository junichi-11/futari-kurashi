...
expect(/<select id="living-area"[^>]*><option>リビング<\/option>/.test(admin),"new article livingArea defaults to リビング");
expect(admin.includes('setSelect(els.room,els.roomCustom,"リビング")'),"next new article resets livingArea to リビング");
...
expect(cards.includes('size="960x720"')&&cards.includes("srcset")&&cards.includes('loading="lazy"'),"high resolution responsive card images");
